...
private:
	...
	SDL_Texture* manual_button_texture_; // the SDL_Texture
	SDL_Texture* exit_button_texture_; // the SDL_Texture
	SDL_Texture* manual_texture_; // the SDL_Texture
	...
	SDL_Rect manual_button_source_rectangle_; // the rectangle for source image
	SDL_Rect manual_button_destination_rectangle_; // for destination
	...
	SDL_Rect manual_source_rectangle_; // the rectangle for source image
	SDL_Rect manual_destination_rectangle_; // for destination
